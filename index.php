...
?>
<link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/rt_stratolinux_j16/css/<?php echo $color_style ?>.css" type="text/css" />
<!--[if lte IE 6]>
<script type="text/javascript" src="<?php echo $this->baseurl ?>/templates/rt_stratolinux_j16/js/ie_suckerfish.js"></script>
<link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/rt_stratolinux_j16/css/styles.ie.css" type="text/css" />
<![endif]-->
<!--[if lte IE 7]>
<link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/rt_stratolinux_j16/css/styles.ie7.css" type="text/css" />
<![endif]-->
</head>
<body>
...
<div id="main">
	<div id="wrapper" class="foreground">
	    <div id="header">
    		<jdoc:include type="modules" name="top" style="stratolinux" />		
		...
		<?php endif; ?>
		<jdoc:include type="modules" name="advertisement" style="stratolinux" />
                ...
                <div id="colmid" class="cdr-<?php echo $rightcolumn_color; ?>">
                    <div id="colright" class="ctr-<?php echo $rightcolumn_color; ?>">
							...
							<div id="col1pad">
                            	<div id="col1">
									...
									<div id="mainmods" class="spacer<?php echo $mainmod_width; ?>">
										<jdoc:include type="modules" name="user1" style="stratolinux" />
										<jdoc:include type="modules" name="user2" style="stratolinux" />
										<jdoc:include type="modules" name="user3" style="stratolinux" />
									</div>
									<?php endif; ?>
									...
									<div id="mainmods2" class="spacer<?php echo $mainmod2_width; ?>">
										<jdoc:include type="modules" name="user4" style="stratolinux" />
										<jdoc:include type="modules" name="user5" style="stratolinux" />
										<jdoc:include type="modules" name="user6" style="stratolinux" />
									</div>
									<?php endif; ?>
	                            </div>
							</div>
                        ...
                        <div id="col2" class="<?php echo $leftcolumn_color; ?>">
                        	<jdoc:include type="modules" name="left" style="stratolinux" />
                        </div>
						<?php endif; ?>
						<?php if ($rightcolumn_width != 0) : ?>
                        <div id="col3" class="<?php echo $rightcolumn_color; ?>">
                        	<jdoc:include type="modules" name="right" style="stratolinux" />
                        </div>
						<?php endif; ?>
                    </div>
                </div>
		...
		<div id="mainmods3" class="spacer<?php echo $mainmod3_width; ?>">
			<jdoc:include type="modules" name="user7" style="stratolinux" />
			<jdoc:include type="modules" name="user8" style="stratolinux" />
			<jdoc:include type="modules" name="user9" style="stratolinux" />
		</div>
		<?php endif; ?>
		...
		<?php endif; ?>
		<jdoc:include type="modules" name="footer" style="stratolinux" />
